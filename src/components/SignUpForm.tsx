...
function SignUpForm(): JSX.Element {
  ...
  const passwordConfirmRef: MutableRefObject<null | HTMLInputElement> =
    useRef(null);
  const passwordConfirmErrRef: MutableRefObject<null | HTMLSpanElement> =
    useRef(null);
  ...
  return (
      <form action="" ref={formRef} className="user_form">
        ...
        <button className="button" onClick={submitForm} type="submit">
          {loading ? <img src={loadingLogo} className="loading-logo" alt="" /> : "Sign Up"}
        </button>
      </form>
  );
}
